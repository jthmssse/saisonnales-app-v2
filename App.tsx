...
const App: React.FC = () => {
  ...
  export default App;import React, { useState, useCallback, useEffect } from 'react';
  import { ActiveTab, Resident, NewReservationData } from './types';
  import { RESIDENTS } from './constants';
  import Header from './components/Header.tsx';
  import Sidebar from './components/Sidebar.tsx';
  ...
  export default App;--- a/c:\Users\hp\saisonnales-app\App.tsx
  +++ b/c:\Users\hp\saisonnales-app\App.tsx
  @@ -82,224 +82,6 @@
         setNewReservationModalOpen(false);
     }, [residents]);
